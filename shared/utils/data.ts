...
export function deleteArrayItems<T extends object>(arr: T[], target: Partial<KeyValue<T>>, comp?: Array<keyof T> | boolean): T[];
export function deleteArrayItems<T>(arr: T[], target?: T | Finder<T> | FinderFunction<T>, comp?: Array<keyof T> | boolean): T[] {
