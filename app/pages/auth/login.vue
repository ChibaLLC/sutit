          ...
          <Card class="p-8">
            ...
            <form @submit.prevent="signInWithEmail" class="space-y-4">
              ...
              <div class="flex items-center justify-between">
                ...
                <NuxtLink href="/auth/forgot-password" class="text-primary text-sm hover:underline">
                  Forgot password?
                </NuxtLink>
              </div>
            ...
            <div class="border-border mt-6 border-t pt-6 text-center">
              <p class="text-muted-foreground text-sm">
                ...
                <NuxtLink href="/auth/register" class="text-primary font-medium hover:underline">
                  Sign up for free
                </NuxtLink>
              </p>
            </div>
