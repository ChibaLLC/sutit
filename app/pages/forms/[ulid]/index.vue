...
import type { Form, Pages, Page } from '@chiballc/nuxt-form-builder';
...
async function submit() {
	try {
		...
		ResolveMpesaPayment(response, data, loading, rerender, complete);
	} catch (e: any) {
		console.log(e);
	} finally {
		loading.value = false;
				...
				<div class="mt-4">
					...
					<div class="relative">
						...
						<small class="help has-text-grey"
							>Press <code>Enter</code> or <code>,</code> to add a contact</small
						>
					</div>
				</div>
