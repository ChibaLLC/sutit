            ...
            <div class="flex flex-wrap items-center mt-32">
                <div class="w-full md:w-5/12 p-6 mr-auto ml-auto bg-white rounded-lg shadow-lg">
                    ...
                    <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700">
                        ...
                        We are a team of dedicated and passionate individuals who are ready to learn and work together
                        for a
                        competitive edge to our businesses.
                        Ultimate goal is to eliminate inefficiencies, lower costs, and enhance overall supply chain
                        performance.
                    </p>
                </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap">
                <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                    <div class="px-6">
                        <img alt="..." src="/images/profile_placeholder.webp"
                ...
                <div class="w-full lg:w-6/12 px-4">
                    <div
                        ...
                        <div class="flex-auto p-5 lg:p-10">
                            ...
                            <div class="relative w-full mb-3">
                                <label class="block uppercase text-gray-700 text-xs font-bold mb-2" for="message">About
                                    you</label><textarea rows="4" cols="80"
                                    class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
