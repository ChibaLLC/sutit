						...
						>
							<div class="px-4 py-5 flex-auto">
								...
								<p class="mt-2 mb-4 text-gray-600">
									We identified the need for end to end efficiency for small business and the whole
									supply chain. For example Whatsapp business among other local tertiary businesses.
								</p>
							</div>
						</div>
					</div>
					<div class="w-full md:w-4/12 px-4 text-center">
						...
						>
							<div class="px-4 py-5 flex-auto">
								...
								<p class="mt-2 mb-4 text-gray-600">
									Innovation, collaboration, sustainability and Business Intelligence at its core. All
									Inclusive, seamless and easy to use.
								</p>
							</div>
						</div>
					</div>
					<div class="pt-6 w-full md:w-4/12 px-4 text-center">
						...
						>
							<div class="px-4 py-5 flex-auto">
								...
								<p class="mt-2 mb-4 text-gray-600">
									Futuristic ubiquitous unified platform where supply chains operate with unparalleled
							...
							<ul class="list-none mt-6">
								<li class="py-2">
									<div class="flex items-center">
										...
										<div>
											<h4 class="text-gray-600">WhatsApp Business Integration ❎</h4>
										</div>
									</div>
								</li>
								<li class="py-2">
									<div class="flex items-center">
										...
										<div>
											<h4 class="text-gray-600">Mpesa Paybill/Till Number Integration ❎</h4>
										</div>
									</div>
								</li>
								...
								<li class="py-2">
									<div class="flex items-center">
										...
										<div>
											<h4 class="text-gray-600">Tracking turn around time after payment</h4>
										</div>
									</div>
								</li>
								<li class="py-2">
									<div class="flex items-center">
										...
										<div>
											<h4 class="text-gray-600">Mpesa Paybill Automated Reconciliations ✅</h4>
										</div>
									</div>
								</li>
							</ul>
					...
					<div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
						<div class="px-6">
							...
							<div class="pt-6 text-center">
								...
								<p class="mt-1 text-sm text-gray-500 uppercase font-semibold">Founding Partner</p>
								<div class="mt-6">
									<button
					...
					<div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
						<div class="px-6">
							...
							<div class="pt-6 text-center">
								...
								<p class="mt-1 text-sm text-gray-500 uppercase font-semibold">Compliance Specialist</p>
								<div class="mt-6">
									<button
					...
					<div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
						<div class="px-6">
							...
							<div class="pt-6 text-center">
								...
								<p class="mt-1 text-sm text-gray-500 uppercase font-semibold">Software Engineer</p>
								<div class="mt-6">
									<button
										class="bg-red-600 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1"
										type="button"
			...
			<div class="container mx-auto px-4 lg:pt-24 lg:pb-64">
				<div class="flex flex-wrap justify-center">
					<div class="w-full lg:w-6/12 px-4">
						...
						<p class="text-lg leading-relaxed mt-4 mb-4 text-gray-500 text-balance">
							Be among the first and get early access to our platform.
							<br />
							Use our API to integrate payments into your platform.
							<br />
							Use our Forms to collect payments from your clients.
							<br />
