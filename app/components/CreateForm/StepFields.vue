<script setup lang="ts">
  ...
  const handleCanvasDragLeave = (event: DragEvent) => {
    if (
      fieldsContainerRef.value &&
      !fieldsContainerRef.value.contains(event.relatedTarget as Node)
    ) {
    ...
    <div class="flex gap-6">
      ...
      <div class="w-56 shrink-0 space-y-4">
        <div v-for="category in fieldTypes" :key="category.category">
          <div class="mb-2 flex items-center gap-2">
            <div class="h-2 w-2 animate-pulse rounded-full" :class="`bg-${category.color}-500`" />
          ...
          <div class="grid gap-1.5">
            <div
              ...
              class="border-border/50 bg-card hover:bg-muted/50 hover:border-border group flex cursor-grab items-center gap-2.5 rounded-lg border p-2 text-left text-sm transition-all active:cursor-grabbing"
            >
              <div
                class="flex h-7 w-7 shrink-0 items-center justify-center rounded-md transition-transform group-hover:scale-110"
      ...
      <div class="min-w-0 flex-1">
          ...
          <div class="flex flex-1 items-center gap-1 overflow-x-auto">
            ...
            >
              <button
                ...
                class="flex shrink-0 items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm transition-all"
                :class="[
              ...
              >
                <input
                  ...
                  @click.stop
                  class="w-20 bg-transparent font-medium text-inherit outline-none"
                />
        ...
        <div
          ...
          class="relative min-h-[300px] space-y-2 transition-all duration-200"
          :class="[
            isDraggingOverCanvas
              ? 'bg-primary/5 border-primary rounded-xl border-2 border-dashed'
        ...
        >
          ...
          <div
            ...
            class="bg-primary pointer-events-none absolute z-10 h-1 rounded-full transition-all duration-150"
            ...
            >
              ...
              >
                <CardContent class="p-4">
                  <!-- Field Header -->
                  <div class="flex cursor-pointer items-center gap-3" @click="startEditing(field)">
                    <GripVertical
                      class="text-muted-foreground/30 h-4 w-4 shrink-0 cursor-grab active:cursor-grabbing"
                    />
                    <div class="min-w-0 flex-1">
                    ...
                    >
                      ...
                      >
                        <ChevronDown v-if="editingFieldId !== field.id" class="h-3.5 w-3.5" />
                        <ChevronUp v-else class="h-3.5 w-3.5" />
                      </Button>
                      <Button
                        variant="ghost"
                        size="sm"
                        class="hover:text-destructive h-7 w-7 p-0"
                        ...
                        <div class="space-y-1.5">
                          ...
                          >
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              class="hover:text-destructive h-8 w-8 shrink-0 p-0"
          ...
          >
            ...
            <h3 class="mb-1 font-semibold">No fields yet</h3>
            <p class="text-muted-foreground text-sm">Drag or click a field type to add it</p>
          </div>
        </div>
      </div>
    </div>
