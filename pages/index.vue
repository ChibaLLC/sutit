<template>
  ...
  <main class="-mt-3">
    <section class="relative pt-16 pb-32 w-full overflow-hidden" style="min-height: 75vh;">
      ...
      <div class="w-full xl:w-10/12 flex flex-col gap-4 mt-8 m-auto" style="max-width: 95%;">
        <div class="p-8 h-fit rounded-md faze w-[500px] max-w-full">
        ...
        <div class="p-4 rounded-md faze w-full mt-8">
          ...
          <div class="flex gap-2 justify-between m-auto max-md:flex-col">
            ...
            <NuxtLink to="/whatsapp" class="flex items-center gap-2 bg-[#262626] text-white rounded p-2 w-[100%]">
              <svg viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none" class="w-8 h-8">
