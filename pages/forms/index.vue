    ...
    <main class="w-full flex flex-col items-center">
      <div class="relative rounded-xl overflow-auto">
        ...
        <div class="shadow-lg overflow-hidden my-8 border-slate-900">
          <table class="border-collapse table-auto w-full text-sm" v-if="formsStores.length > 0">
            <thead>
            <tr>
            ...
            <tr v-for="formStore in formsStores" :key="formStore.forms.ulid"
              ...
              <td class="border-b border-slate-100 p-4 pl-8 text-slate-700 flex items-center">
                ...
                <span class="p-2 text-white rounded" @click.prevent="getShareableLink(formStore.forms.ulid)"
                      title="copy">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5 fill-slate-700"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                         :id="`copy_success_${formStore.forms.ulid}`" class="w-5 h-5 fill-slate-700 hidden">
                      <path
