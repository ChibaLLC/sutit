...
async function submit() {
    ...
    await $fetch(`/api/v1/auth/reset?email=${details.email}&origin=${window.location.origin}&redirect=${redirect}`, {
        method: 'GET',
            ...
            <div class="flex content-center items-center justify-center h-full">
                <div class="w-full lg:w-4/12 px-4">
                    ...
                    <div class="flex flex-wrap mt-6">
                        <div class="w-1/2">
                            <NuxtLink class="text-slate-900" :to="`/auth/login?redirect=${redirect}`">
